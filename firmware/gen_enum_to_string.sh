...
java -DSystemOut.name=logs/gen_java_enum -cp ../java_tools/enum2string.jar com.gerefi.ToJavaEnum -enumInputFile controllers/sensors/sensor_type.h -outputPath ../java_console/io/src/main/java/com/gerefi/enums
[ $? -eq 0 ] || { echo "ERROR generating sensors"; exit 1; }

java -DSystemOut.name=logs/gen_java_enum -cp ../java_tools/enum2string.jar com.gerefi.ToJavaEnum -enumInputFile controllers/algo/engine_types.h   -outputPath ../java_console/io/src/main/java/com/gerefi/enums -definition integration/gerefi_config.txt
