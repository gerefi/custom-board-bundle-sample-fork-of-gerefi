...
#        for example ./gen_config_board.sh hellen/hellen128 hellen128 gerefi_hellen128mercedes.ini
#                 or ./gen_config_board.sh hellen/hellen128 hellen128
# which is short for ./gen_config_board.sh hellen/hellen128 hellen128 gerefi_hellen128.ini
...
# work in progress: migrating to gerefi_${BUNDLE_NAME}.txt
...
java \
 ...
 $COMMON_GEN_CONFIG \
  ...
  -c_defines        controllers/generated/gerefi_generated.h \
