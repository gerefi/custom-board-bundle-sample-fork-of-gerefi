...
static void setMiataNB2_MRE_common() {
	...
	// MRE has a special main relay control low side pin - gerefi firmware is totally not involved with main relay control
	//
	// fuelPumpPin output is inherited from boards/microgerefi/board_configuration.cpp
	// fanPin output is inherited from boards/microgerefi/board_configuration.cpp
	//
	// crank trigger input is inherited from boards/microgerefi/board_configuration.cpp
	// map.sensor.hwChannel input is inherited from boards/microgerefi/board_configuration.cpp
	// tps1_1AdcChannel input is inherited from boards/microgerefi/board_configuration.cpp
	// afr.hwChannel input is inherited from boards/microgerefi/board_configuration.cpp
