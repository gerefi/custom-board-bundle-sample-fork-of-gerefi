...
import com.gerefi.newparse.outputs.CStructWriter;
import com.gerefi.newparse.outputs.OutputChannelWriter;
import com.gerefi.newparse.outputs.PrintStreamAlwaysUnix;
import com.gerefi.newparse.outputs.TsWriter;
...
public class NewParseHelper {
    public static ParseState parse(String input) throws IOException {
        ...
        gerefiParseErrorStrategy.parseDefinitionString(parseState.getListener(), input);
        return parseState;
    }
