...
//                    gerefiParseErrorStrategy.parseDefinitionFile(parseState.getListener(), prependFile);
                }
            }
...
//                gerefiParseErrorStrategy.parseDefinitionFile(parseState.getListener(), state.definitionInputFile);
            }
            ...
            // writer.writeTunerstudio(parseState, tsInputFileFolder + "/gerefi.input", tsInputFileFolder + "/" + state.tsFileOutputName);
        }
