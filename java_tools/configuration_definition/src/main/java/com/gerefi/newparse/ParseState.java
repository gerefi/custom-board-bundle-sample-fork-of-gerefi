...
import com.gerefi.generated.gerefiConfigGrammarBaseListener;
import com.gerefi.generated.gerefiConfigGrammarParser;
import com.gerefi.newparse.parsing.*;
import org.antlr.v4.runtime.tree.ParseTreeListener;

import java.util.*;
import java.util.regex.Pattern;

import static com.gerefi.VariableRegistry.AUTO_ENUM_SUFFIX;
...
public class ParseState implements DefinitionsState {
    ...
    public ParseTreeListener getListener() {
        return new gerefiConfigGrammarBaseListener() {

    @Override
    public void exitContent(gerefiConfigGrammarParser.ContentContext ctx) {
        assert(scopes.empty());
        assert(scope == null);
    ...
    @Override
    public void exitDefinition(gerefiConfigGrammarParser.DefinitionContext ctx) {
    ...
    @Override
    public void enterTypedef(gerefiConfigGrammarParser.TypedefContext ctx) {
        typedefName = ctx.identifier().getText();
    }

    @Override
    public void exitTypedef(gerefiConfigGrammarParser.TypedefContext ctx) {
        typedefName = null;
    }

    @Override
    public void exitScalarTypedefSuffix(gerefiConfigGrammarParser.ScalarTypedefSuffixContext ctx) {
    ...
    @Override
    public void enterEnumTypedefSuffix(gerefiConfigGrammarParser.EnumTypedefSuffixContext ctx) {
    ...
    @Override
    public void exitStringTypedefSuffix(gerefiConfigGrammarParser.StringTypedefSuffixContext ctx) {
    ...
    @Override
    public void enterStruct(gerefiConfigGrammarParser.StructContext ctx) {
    ...
    @Override
    public void enterUnionField(gerefiConfigGrammarParser.UnionFieldContext ctx) {
    ...
    void handleFieldOptionsList(FieldOptions options, gerefiConfigGrammarParser.FieldOptionsListContext ctx) {
        ...
        for (gerefiConfigGrammarParser.FieldOptionContext fo : ctx.fieldOption()) {
    ...
    @Override
    public void exitScalarField(gerefiConfigGrammarParser.ScalarFieldContext ctx) {
    ...
    @Override
    public void enterBitField(gerefiConfigGrammarParser.BitFieldContext ctx) {
        String name = ctx.identifier().getText();
    ...
    @Override
    public void exitArrayField(gerefiConfigGrammarParser.ArrayFieldContext ctx) {
        String type = ctx.identifier(0).getText();
        String name = ctx.identifier(1).getText();
    ...
    @Override
    public void exitArrayLengthSpec(gerefiConfigGrammarParser.ArrayLengthSpecContext ctx) {
    ...
    @Override
    public void enterUnusedField(gerefiConfigGrammarParser.UnusedFieldContext ctx) {
        scope.structFields.add(new UnusedField(Integer.parseInt(ctx.integer().getText())));
    }

    @Override
    public void exitStruct(gerefiConfigGrammarParser.StructContext ctx) {
    ...
    @Override
    public void exitUnionField(gerefiConfigGrammarParser.UnionFieldContext ctx) {
        assert(scope != null);
    ...
    @Override
    public void exitEvalNumber(gerefiConfigGrammarParser.EvalNumberContext ctx) {
        evalStack.push(Double.parseDouble(ctx.floatNum().getText()));
    }

    @Override
    public void exitEvalReplacement(gerefiConfigGrammarParser.EvalReplacementContext ctx) {
        // Strip any @@ symbols
    ...
    @Override
    public void exitEvalMul(gerefiConfigGrammarParser.EvalMulContext ctx) {
    ...
    @Override
    public void exitEvalDiv(gerefiConfigGrammarParser.EvalDivContext ctx) {
        Double right = evalStack.pop();
        Double left = evalStack.pop();
    ...
    @Override
    public void exitEvalAdd(gerefiConfigGrammarParser.EvalAddContext ctx) {
        Double right = evalStack.pop();
        Double left = evalStack.pop();
    ...
    @Override
    public void exitEvalSub(gerefiConfigGrammarParser.EvalSubContext ctx) {
        Double right = evalStack.pop();
        Double left = evalStack.pop();
    ...
    @Override
    public void exitNumexpr(gerefiConfigGrammarParser.NumexprContext ctx) {
