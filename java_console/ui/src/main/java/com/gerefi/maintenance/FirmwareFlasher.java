...
public class FirmwareFlasher {
    public static final String IMAGE_FILE = INPUT_FILES_PATH + "/" + "gerefi.bin";
    public static final String IMAGE_NO_ASSERTS_FILE = INPUT_FILES_PATH + "/" + "gerefi_no_asserts.bin";
    /**
     * SWD ST-LINK/V2 mode
     */
