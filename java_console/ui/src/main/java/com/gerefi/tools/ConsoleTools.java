...
import com.gerefi.io.stream.PCanIoStream;
import com.gerefi.io.stream.SocketCANIoStream;
...
public class ConsoleTools {
    ...
    static {
        ...
        registerTool("firing_order", ConsoleTools::runFiringOrderTool, "NOT A USER TOOL. Development tool relating to adding new firing order into gerefi firmware.");
