...
import com.gerefi.maintenance.FirmwareFlasher;
...
public class StartupFrame {
    ...
    public static final String LINK_TEXT = "gerefi (c) 2012-2023";
    private static final String URI = "http://gerefi.com/?java_console";
    // private static final int gerefi_ORANGE = 0xff7d03;
...
//        AudioPlayback.start();
    ...
    public void chooseSerialPort() {
        ...
        //connectButton.setBackground(new Color(gerefi_ORANGE)); // custom orange
